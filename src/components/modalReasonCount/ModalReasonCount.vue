    ...
    <div class="black-back" @click="closeModal">
        <div class="contract-base" @click.stop="">
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(0)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[0]">
                        <div v-for="i in countReason.semCondicoes.regions" class="reasons-outer">
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(1)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[1]">
                        <div v-for="i in countReason.contratoNovo.regions" class="reasons-outer">
                            <div v-if="i.total > 0" class="reasons">
                                <label>{{ i.label }}:</label>
                                <label>{{ i.total }}</label>
                            </div>
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(2)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[2]">
                        <div v-for="i in countReason.mudouCidade.regions" class="reasons-outer">
                            <div v-if="i.total > 0" class="reasons">
                                <label>{{ i.label }}:</label>
                                <label>{{ i.total }}</label>
                            </div>
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(3)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[3]">
                        <div v-for="i in countReason.outraEmpresa.regions" class="reasons-outer">
                            <div v-if="i.total > 0" class="reasons">
                                <label>{{ i.label }}:</label>
                                <label>{{ i.total }}</label>
                            </div>
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(4)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[4]">
                        <div v-for="i in countReason.semInteresse.regions" class="reasons-outer">
                            <div v-if="i.total > 0" class="reasons">
                                <label>{{ i.label }}:</label>
                                <label>{{ i.total }}</label>
                            </div>
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(5)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[5]">
                        <div v-for="i in countReason.insatisfacao.regions" class="reasons-outer">
                            <div v-if="i.total > 0" class="reasons">
                                <label>{{ i.label }}:</label>
                                <label>{{ i.total }}</label>
                            </div>
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(6)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[6]">
                        <div v-for="i in countReason.titularFalecido.regions" class="reasons-outer">
                            <div v-if="i.total > 0" class="reasons">
                                <label>{{ i.label }}:</label>
                                <label>{{ i.total }}</label>
                            </div>
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(7)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[7]">
                        <div v-for="i in countReason.outroPlanoNosso.regions" class="reasons-outer">
                            <div v-if="i.total > 0" class="reasons">
                                <label>{{ i.label }}:</label>
                                <label>{{ i.total }}</label>
                            </div>
            ...
            <div div="region-outer">
                <div class="region" @click="toggleRegions(8)">
                ...
                <Transition name="region-details">
                    <div v-if="reasonState[8]">
                        <div v-for="i in countReason.outros.regions" class="reasons-outer">
                            <div v-if="i.total > 0" class="reasons">
                                <label>{{ i.label }}:</label>
                                <label>{{ i.total }}</label>
                            </div>
